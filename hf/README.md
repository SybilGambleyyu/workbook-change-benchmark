...
Excel workbooks. Each of its 18 synthetic cases supplies a baseline workbook,
...
Table scope expansion with unchanged structured-reference text and a newly
introduced `INDIRECT` reference), and a small multi-workbook portfolio.
