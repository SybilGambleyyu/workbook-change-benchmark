...
Excel workbooks. Each of its 23 synthetic cases supplies a baseline workbook,
...
legacy-CSE array formula that switches to dynamic-array semantics, and a small
