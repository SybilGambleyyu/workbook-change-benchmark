...
Excel workbooks. Each of its 20 synthetic cases supplies a baseline workbook,
...
introduced `INDIRECT` reference, and unchanged `INDIRECT`/`OFFSET` formulas
whose dynamic selectors change), and a small multi-workbook portfolio.
